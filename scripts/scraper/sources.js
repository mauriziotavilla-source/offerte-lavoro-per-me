...
module.exports = [
  ...
  },
  {
    ...
    sede: 'Sicilia',
    url: 'https://www.regione.sicilia.it/la-regione-informa/concorsi',
    ...
    nota: 'Disattivata: al 06/2026 questo indirizzo risponde 404 (la Regione ha cambiato pagina). Quando trovi l\'URL aggiornato dei concorsi, incollalo in "url" e rimetti enabled: true.',
  },
  {
    id: 'inpa-concorsi',
    enabled: false,
  ...
  },
  {
    ...
    sede: 'Italia',
    url: 'https://www.jobmetoo.com/it/offerte-lavoro',
    selectors: ['a'],
    includeKeywords: PAROLE_PROFILO,
    excludeKeywords: ['privacy', 'cookie'],
    defaultAree: ['amministrazione', 'contabilita'],
