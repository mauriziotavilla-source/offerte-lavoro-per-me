...
const ESCLUDI_CATEGORIA_PROTETTA = [
  ...
  'cat. prot. art.1', 'categorie protette art. 1', 'invalidità 46',
];
...
module.exports = [
  {
    ...
    searches: [
      ...
      { keywords: 'revisore conti', location: 'Messina' },
      { keywords: 'controllo gestione', location: 'Messina' },
      { keywords: 'addetto contabilità', location: 'Messina' },
      { keywords: 'consulente fiscale', location: 'Messina' },
    ],
  ...
  },
  {
    ...
    searches: [
      ...
      { keywords: 'art 18 legge 68', location: 'Messina' },
    ...
    defaultAree: ['amministrazione', 'contabilita'],
    profili: ['Orfani di guerra equiparati — art. 18 L.68/99'],
    regioni_ammesse: ['sicilia'],
    nota: 'Orfani ed equiparati (art. 18 L.68/99, art. 7 L.585/1971). Esclusi solo bandi art. 1 (invalidità).',
  },
  {
    ...
    searches: [
      ...
      { keywords: 'art 18 legge 68', location: 'Sicilia' },
  ...
  },
  {
    ...
    tipo: 'categoria_protetta',
    ente: 'Regione Siciliana — Avviamenti art. 18 (CPI Messina)',
    sede: 'Messina',
    ...
    includeKeywords: ['avvis', 'graduator', 'l.68', 'legge 68', 'art. 18', 'art.18', 'art. 8', 'art.8', 'orfani', 'equiparat', 'enti pubblici', 'decreto', 'rettifica', 'elenco'],
    excludeKeywords: ESCLUDI_CATEGORIA_PROTETTA,
    defaultAree: ['amministrazione'],
    profili: ['Orfani di guerra equiparati — CPI Messina art. 18'],
    regioni_ammesse: ['sicilia'],
    nota: 'Avvisi CPI Messina per orfani ed equiparati (art. 18 L.68/99). Esclusi bandi solo art. 1.',
  },
  {
    ...
    sectionHeading: 'messina e villafranca',
    includeKeywords: ['avvis', 'graduator', 'l.68', 'legge 68', 'art. 18', 'art.18', 'art. 8', 'art.8', 'orfani', 'equiparat', 'enti pubblici', 'asp messina', 'decreto'],
    excludeKeywords: ESCLUDI_CATEGORIA_PROTETTA,
    defaultAree: ['amministrazione'],
    profili: ['Orfani di guerra equiparati — CPI Messina art. 18'],
    regioni_ammesse: ['sicilia'],
  },
  {
    ...
    selectors: ['a'],
    includeKeywords: ['art. 18', 'art.18', 'art. 8', 'art.8', 'orfani', 'equiparat'],
    excludeKeywords: ESCLUDI_CATEGORIA_PROTETTA,
    defaultAree: ['amministrazione', 'contabilita'],
    profili: ['Orfani di guerra equiparati'],
    regioni_ammesse: ['sicilia'],
    nota: 'Disabilitato: verificare manualmente avvisi ditte private per orfani/equiparati.',
  },
  {
